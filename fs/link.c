...
PUBLIC int do_unlink()
{
	...
	{
		printk("FS: do_unlink() : search_file() returns invalid inode: %s\n", 
			pathname);
		return -1;
	}
	...
	{
		printk("Cannot remove file %s. It is not a regular file.\n", 
			pathname);
		return -1;
	}
	...
	{
		printk("Cannot remove file %s. It was opened(inode->i_cnt = %d).\n", 
